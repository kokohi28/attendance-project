...
package com.divt.attendance.android.support;
...
public class AspectRatioDialog extends DialogFragment {
  ...
  private RatioDialogListener mRatioDialogListener;

  public static AspectRatioDialog newInstance(Set<AspectRatio> ratios,
                                              AspectRatio currentRatio,
                                              RatioDialogListener callback
                                              ) {
    final AspectRatioDialog fragment = new AspectRatioDialog();
    fragment.mRatioDialogListener = callback;
  ...
  public Dialog onCreateDialog(Bundle savedInstanceState) {
    ...
    return new AlertDialog.Builder(getActivity())
        .setAdapter(adapter, (dialog, position) -> {
          if (mRatioDialogListener != null) {
            mRatioDialogListener.onAspectRatioSelected(ratios[position]);
          }
        })
        .create();
  }
  ...
  public interface RatioDialogListener {
