package com.divt.attendance.android.utils.imagecompress;
...
public class Compressor {
  ...
  public File compressAndSave(File imageFile, String filename) throws IOException {
    return compressToFile(imageFile, filename);
  }
